...
from .mpm import StripPooling
from .resnet import SPBlock, resnet34
...
#         self.strip_pool1 = StripPooling(512, (20, 12), norm_layer, up_kwargs)
#         self.strip_pool2 = StripPooling(512, (20, 12), norm_layer, up_kwargs)
#         self.strip_pool3 = StripPooling(512, (20, 12), norm_layer, up_kwargs)
#         self.strip_pool4 = StripPooling(512, (20, 12), norm_layer, up_kwargs)
        
        self.dblock = Dblock(512)
#         self.spdblock = SPDblock(512, (20, 12), norm_layer, up_kwargs)
